...
SECRET_KEY = 'onqrbc1xd431$2eawpk+(ty3eye!kj&z!lrm6f%*=#&@!xol(g'
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, "todosite", "templates")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_ROOT = os.environ.get('STATICFILES_ROOT', '/staticfiles')
